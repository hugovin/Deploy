            ...
            <th valign="top">
             ...
             <td>
                  <% foreach (var orderStatus in Model.OrderStatus)
                    {%>
                    <input type="checkbox" name="rdOrderStatus" value="<%= orderStatus.Id %>" /><label><%: orderStatus.Text %> </label> &nbsp;|&nbsp;
                   <% } %>  
        ...
        <tr>
            ...
            <td valign="top">
                <ul id="ulCustomShipments"class="noBullets">
                    <li id="liCus1" class=""><%: Html.TextBoxFor(model => model.CustomShip1, new { @class = "inp-form", placeholder = "Carrier - Description" })%></li>
                    <li id="liCus2" class="dn"><%: Html.TextBoxFor(model => model.CustomShip2, new { @class = "inp-form", placeholder = "Carrier - Description" })%><span id="spnCustomShip2" class="icon-2 "></span></li>
                    <li id="liCus3" class="dn"><%: Html.TextBoxFor(model => model.CustomShip3, new { @class = "inp-form", placeholder = "Carrier - Description" })%><span  id="spnCustomShip3" class="icon-2 "></span></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageScripts" runat="server">
    <script type="text/javascript" src="../../Scripts/Store/AddStore.js"></script>
</asp:Content>
